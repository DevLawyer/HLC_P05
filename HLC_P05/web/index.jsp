        ...
        <main class="container-fluid bg-main-2 p-5">
            <section class="row">
                <article class="col text-center">
                    <img class="w-25" src="00_resources/images/esa_logo_xt.png" alt="ESA Logo Big">
                    <h1 class="fg-main-2 m-4">Conoce a la Agencia Espacial Europea</h1>
                </article>
            </section>
            <section class="row justify-content-center mt-4">
                <div class="col-sm-6 fg-main-2">
