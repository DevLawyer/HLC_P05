                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="./list1.jsp">ESA Members Detail</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active selected" href="./list2.jsp">ESA Members Complete</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <th class="dcf-txt-center" scope="col">KEY</th>
                            <th class="dcf-txt-center" scope="col">NAME</th>
                            <th class="dcf-txt-center" scope="col">CONTRIBUTION</th>
                            <th class="dcf-txt-center" scope="col">ENTRY DATE</th>
                        </tr>
                    </thead>
                    <c:forEach var="entry" items="${pageScope.mem}">
                        <tr>
                            <th scope="row"><c:out value="${entry.key}"/></th>
                            <td data-label="NAME"><c:out value="${entry.value.getName()}"/></td>
                            <td data-label="NAME"><c:out value="${entry.value.getContribution()} mill. €"/></td>
                            <td data-label="NAME"><c:out value="${entry.value.getEntryDate()}"/></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
